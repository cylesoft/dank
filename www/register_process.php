...
$new_user_row = $mysqli->query("INSERT INTO users (email, steakonions, last_activity_ts, tsc) VALUES ($new_user_email_db, $new_user_pwd_hash_db, UNIX_TIMESTAMP(), UNIX_TIMESTAMP())");
if (!$new_user_row) {
