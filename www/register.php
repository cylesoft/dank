...
<div class="section group">
	<div class="col s12">
		...
		<tr><td>Your Password:</td><td><input tabindex="2" name="p1" type="password" /></td></tr>
		<tr><td>Your Password:</td><td><input tabindex="3" name="p2" type="password" /></td></tr>
		<tr><td>Invite Code:</td><td><input tabindex="4" name="i" type="password" /></td></tr>
		<tr><td><input tabindex="5" type="submit" value="sign up &raquo;" /></td><td></td></tr>
		</table>
		</form>
	</div>
</div>
